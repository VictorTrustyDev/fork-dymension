...
type OwnedDymNames struct {
	DymNames []string `protobuf:"bytes,1,rep,name=dym_names,json=dymNames,proto3" json:"dym_names,omitempty"`
}

func (m *OwnedDymNames) Reset()         { *m = OwnedDymNames{} }
func (m *OwnedDymNames) String() string { return proto.CompactTextString(m) }
func (*OwnedDymNames) ProtoMessage()    {}
func (*OwnedDymNames) Descriptor() ([]byte, []int) {
	return fileDescriptor_463436600bef60e6, []int{2}
}
func (m *OwnedDymNames) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *OwnedDymNames) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_OwnedDymNames.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *OwnedDymNames) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OwnedDymNames.Merge(m, src)
}
func (m *OwnedDymNames) XXX_Size() int {
	return m.Size()
}
func (m *OwnedDymNames) XXX_DiscardUnknown() {
	xxx_messageInfo_OwnedDymNames.DiscardUnknown(m)
}

var xxx_messageInfo_OwnedDymNames proto.InternalMessageInfo

func (m *OwnedDymNames) GetDymNames() []string {
	if m != nil {
		return m.DymNames
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*OwnedDymNames)(nil), "dymensionxyz.dymension.dymns.OwnedDymNames")
}
...
var fileDescriptor_463436600bef60e6 = []byte{
	...
	,
}
...
func (m *OwnedDymNames) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *OwnedDymNames) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *OwnedDymNames) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *OwnedDymNames) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *OwnedDymNames) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: OwnedDymNames: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: OwnedDymNames: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
