...
func Test_parseMigrateChainIdsProposal(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			metadataFile: "test_proposals/invalid_update_chain_id_proposal_test.json",
			wantErr:      true,
		},
		{
			name:         "pass - update single",
			metadataFile: "test_proposals/update_single_chain_id_proposal_test.json",
			wantErr:      false,
			want: []dymnstypes.MigrateChainId{
				{
		...
		},
		{
			...
			metadataFile: "test_proposals/update_multiple_chain_ids_proposal_test.json",
			wantErr:      false,
			want: []dymnstypes.MigrateChainId{
				{
					PreviousChainId: "cosmoshub-3",
