...
func TestIsValidDymName(t *testing.T) {
	t.Run("maximum accepted length is 66", func(t *testing.T) {
		require.True(t, IsValidDymName("123456789012345678901234567890123456789012345678901234567890123456"))
		require.False(t, IsValidDymName("1234567890123456789012345678901234567890123456789012345678901234567"))
	})
...
func TestIsValidSubDymName(t *testing.T) {
	t.Run("maximum accepted length is 66", func(t *testing.T) {
		require.True(t, IsValidSubDymName("123456789012345678901234567890123456789012345678901234567890123456"))
		require.False(t, IsValidSubDymName("123456789012345678901234567890123456.789012345678901234567890123456"))
	})
