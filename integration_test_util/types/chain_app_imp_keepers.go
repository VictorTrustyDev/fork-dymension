...
func (c chainAppImp) DelayedAckKeeper() *delayedackkeeper.Keeper {
	return &c.app.DelayedAckKeeper
}
...
func (c chainAppImp) RollAppKeeper() *rollappkeeper.Keeper {
	return &c.app.RollappKeeper
}

func (c chainAppImp) SequencerKeeper() *sequencerkeeper.Keeper {
	return &c.app.SequencerKeeper
}
...
func (c chainAppImp) StreamerKeeper() *streamerkeeper.Keeper {
	return &c.app.StreamerKeeper
}
